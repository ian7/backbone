...
//MN: mine custom stuff goes here	
...
//MN: this is original backbone
//MN:      this.add(models, _.extend({silent: true}, options));
  ...
  var viewOptions = ['model', 'collection', 'el', 'id', 'attributes', 'className', 'tagName','context'];
